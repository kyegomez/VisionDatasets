...
def generate_qa_for_image(image_path):
    ...
    query = tokenizer.from_list_format([
        {'image': image_path},
        {'text': "Begin by describing what you see in the image. Extract as many features as you can in english. Make sure you are as descriptive as possible in english."},
    ])
